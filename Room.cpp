...
/**
        * Return vector id
    */
std::vector <int> Room::getId() const
{
    return id;
}
...
void ViewRoom::setFloor(int floor) {
    Room::setFloor(floor);
}

void ViewRoom::setNumber(int number) {
    Room::setNumber(number);
}

void ViewRoom::setCapacity(int capacity) {
    Room::setCapacity(capacity);
}

void ViewRoom::setAvailable(bool avail) {
...
void NoViewRoom::setCapacity(int capacity) {
    Room::setCapacity(capacity);
}

void NoViewRoom::setNumber(int number) {
    Room::setNumber(number);
}

void NoViewRoom::setFloor(int floor) {
    Room::setFloor(floor);
}

void NoViewRoom::setAvailable(bool avail) {
    Room::setAvailable(avail);
}
