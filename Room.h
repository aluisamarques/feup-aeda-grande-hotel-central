...
protected:
    ...
    std::vector <int> id;                                               ///< private vector id
...
public:
    ...
    */
    ...
    /**
        ...
        * Return "Room"
    */
    virtual std::string RoomType(){ std::cout<<"Room" << std::endl; return "Room";};
...
public:
    ...
    */
    ...
    /**
        ...
        * Return "NoViewRoom"
    */
    virtual std::string RoomType(){ std::cout<<"NoViewRoom" << std::endl; return "NoViewRoom";};
...
public:
    ...
    */
    ...
    /**
        ...
        * Return "ViewRoom"
    */
    virtual std::string RoomType(){ std::cout<<"ViewRoom" << std::endl; return "ViewRoom";};
...
public:
    ...
    */
    ...
    /**
        ...
        * Return "Suite"
    */
    virtual std::string RoomType(){ std::cout<<"Suite" << std::endl; return "Suite";};
